...
async function getMyId() {
    ...
    try {
        const res = await fetch("https://socialportfolio-backend.onrender.com/me", {
            headers: {
...
async function loadUsers() {
    ...
    const res = await fetch("https://socialportfolio-backend.onrender.com/users");
    const data = await res.json();
...
async function loadUsers(searchText = "") {
    const url = searchText
        ? `https://socialportfolio-backend.onrender.com/users?search=${encodeURIComponent(searchText)}`
        : `https://socialportfolio-backend.onrender.com/users`;
